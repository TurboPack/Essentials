...
{*********************************************************}
{* SRMGR: string resource runtime manager                *}
{*********************************************************}
...
var
  TpsResStrings : TEsStringResource; {error strings for this unit}
...
procedure TEsStringResource.ChangeResource(Instance : THandle; const ResourceName : string);
begin
  srCloseResource;
...
constructor TEsStringResource.Create(Instance : THandle; const ResourceName : string);
begin
  inherited Create;
...
destructor TEsStringResource.Destroy;
begin
  srCloseResource;
  inherited Destroy;
end;
...
function TEsStringResource.GetWideChar(Ident : TInt32;
...
function TEsStringResource.GetAsciiZ(Ident : TInt32;
...
function TEsStringResource.GetString(Ident : TInt32) : string;
var
  P : PIndexRec;
  Src : PWideChar;
  Len : Integer;
...
procedure TEsStringResource.srCloseResource;
begin
...
function TEsStringResource.srFindIdent(Ident : TInt32) : PIndexRec;
var
  L, R, M : TInt32;
begin
...
procedure TEsStringResource.srLock;
begin
...
procedure TEsStringResource.srLoadResource(Instance : THandle; const ResourceName : string);
var
  H : THandle;
...
procedure TEsStringResource.srOpenResource(Instance : THandle; const ResourceName : string);
begin
...
procedure TEsStringResource.srUnLock;
begin
