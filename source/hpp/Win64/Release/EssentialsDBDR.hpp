...
// (DO NOT EDIT: machine generated header) 'EssentialsDBDR.dpk' rev: 32.00 (Windows)

#ifndef EssentialsdbdrHPP
#define EssentialsdbdrHPP
...
#include <EsConst.hpp>	// (EssentialsDR)
#include <EsData.hpp>	// (EssentialsDR)
#include <EsSrMgr.hpp>	// (EssentialsDR)
#include <EsUtil.hpp>	// (EssentialsDR)
#include <EsLabel.hpp>	// (EssentialsDR)
#include <EsBase.hpp>	// (EssentialsDR)
#include <EsCal.hpp>	// (EssentialsDR)
#include <EsCalc.hpp>	// (EssentialsDR)
#include <EsEdPop.hpp>	// (EssentialsDR)
#include <EsEdCal.hpp>	// (EssentialsDR)
#include <EsEdCalc.hpp>	// (EssentialsDR)
// SO_SFX: 250
// PRG_EXT: .bpl
...
namespace Essentialsdbdr
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Essentialsdbdr */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ESSENTIALSDBDR)
using namespace Essentialsdbdr;
#endif
#pragma pack(pop)
#pragma option pop
