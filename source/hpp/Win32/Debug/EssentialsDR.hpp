...
// (DO NOT EDIT: machine generated header) 'EssentialsDR.dpk' rev: 33.00 (Windows)
...
namespace Essentialsdr
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Essentialsdr */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ESSENTIALSDR)
using namespace Essentialsdr;
#endif
#pragma pack(pop)
#pragma option pop
