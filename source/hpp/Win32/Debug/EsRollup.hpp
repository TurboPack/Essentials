...
// (DO NOT EDIT: machine generated header) 'EsRollUp.pas' rev: 33.00 (Windows)
...
protected:
	...
	DYNAMIC void __fastcall DoOnRollDown();
	DYNAMIC void __fastcall DoOnRollUp();
...
public:
	...
	__fastcall virtual ~TEsCustomRollUp();
};
...
public:
	...
	/* TEsCustomRollUp.Destroy */ inline __fastcall virtual ~TEsRollUp() { }
