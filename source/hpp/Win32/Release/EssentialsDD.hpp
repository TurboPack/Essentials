...
// (DO NOT EDIT: machine generated header) 'EssentialsDD.dpk' rev: 32.00 (Windows)

#ifndef EssentialsddHPP
#define EssentialsddHPP
...
#include <EsBase0.hpp>
#include <EsReg.hpp>
#include <EsLabel0.hpp>
#include <EsLabel1.hpp>
#include <EsDir.hpp>
#include <EsAbout0.hpp>
#include <EsWebPE.hpp>
...
namespace Essentialsdd
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Essentialsdd */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ESSENTIALSDD)
using namespace Essentialsdd;
#endif
#pragma pack(pop)
#pragma option pop
